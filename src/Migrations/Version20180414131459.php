...
/**
 * Version20180414131459.
 */
class Version20180414131459 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE cash_back (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', cash_back_platform_id INT DEFAULT NULL, cash_back_image_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', title VARCHAR(64) NOT NULL, description TEXT DEFAULT NULL, cashback_condition TEXT NOT NULL, url VARCHAR(255) NOT NULL, site_url VARCHAR(255) NOT NULL COMMENT \'адрес сайта-заказчика\', cash VARCHAR(255) NOT NULL, external_id INT DEFAULT NULL, active TINYINT(1) NOT NULL, status ENUM(\'NOT_PARTNER\', \'AWAITING_PARTNERSHIP\', \'APPROVED_PARTNERSHIP\', \'REJECTED_PARTNERSHIP\', \'CLOSES_COMPANY\') NOT NULL COMMENT \'Статус кешбека(DC2Type:CashBackStatusEnumType)\', rating NUMERIC(4, 1) NOT NULL COMMENT \'Рейтинг площадки\', INDEX IDX_5048085A32EBAE9B (cash_back_platform_id), UNIQUE INDEX UNIQ_5048085A5C9683B9 (cash_back_image_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE cash_back_image (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', extension VARCHAR(5) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
